...
if user_string.isdecimal():
    print("Your input is numeric, hence no upper case!")
else:
    print("Your input in upper case would be: " + user_string.upper())
...
print("Your input contains all numeric characters: " + str(user_string.isdecimal()))
...
print("Your input contains all numeric characters: " + true_or_false)
